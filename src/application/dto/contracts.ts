...
export type ApiErrorCode =
  ...
  | "RATE_LIMITED"
  | "REGISTRATION_IDEMPOTENCY_KEY_REUSED"
  | "REGISTRATION_ACTIVATION_INVALID"
  | "REGISTRATION_CODE_INVALID"
  | "REGISTRATION_CODE_ATTEMPTS_EXHAUSTED"
  | "REGISTRATION_EMAILS_MUST_DIFFER"
  | "REGISTRATION_PERSONAL_LOGIN_UNAVAILABLE"
  | "REGISTRATION_ACCOUNT_CREATION_IN_PROGRESS"
  | "REGISTRATION_EMAIL_DELIVERY_FAILED"
  | "REGISTRATION_CONFIGURATION_INVALID"
  | "PERSISTENCE_FAILURE"
